...
export const WK_TEAMS = {
    'USA': { naam:'Verenigde Staten', vlag:'🇺🇸', nickname:'Stars & Stripes',
        woorden:['Pulisic','McKennie','Musah','Robinson','Turner','Stars & Stripes','Gastheerland','Washington','LA Galaxy'] },
    'MEX': { naam:'Mexico', vlag:'🇲🇽', nickname:'El Tri',
        woorden:['Edson Álvarez','Lozano','Santiago Giménez','Montes','Chavez','El Tri','Azteca','Mexico-Stad','Club América'] },
    ...
    'BRA': { naam:'Brazilië', vlag:'🇧🇷', nickname:'Seleção',
        woorden:['Vinicius Jr','Rodrygo','Raphinha','Militão','Bruno Guimarães','Seleção','Copacabana','Brasília','Flamengo'] },
    ...
    'COL': { naam:'Colombia', vlag:'🇨🇴', nickname:'Los Cafeteros',
        woorden:['Luis Díaz','James Rodríguez','Daniel Muñoz','Lerma','Jhon Durán','Los Cafeteros','Bogotá','Atlético Nacional'] },
    ...
    'PAR': { naam:'Paraguay', vlag:'🇵🇾', nickname:'La Albirroja',
        woorden:['Almirón','Enciso','Gustavo Gómez','Sanabria','Villasanti','La Albirroja','Asunción','Olimpia'] },
    ...
    'BEL': { naam:'België', vlag:'🇧🇪', nickname:'Rode Duivels',
        woorden:['De Bruyne','Lukaku','Doku','Amadou Onana','Faes','Rode Duivels','Brussel','Club Brugge'] },
    'FRA': { naam:'Frankrijk', vlag:'🇫🇷', nickname:'Les Bleus',
        woorden:['Mbappé','Griezmann','Tchouaméni','Camavinga','Maignan','Les Bleus','Parijs','Paris Saint-Germain'] },
    'GER': { naam:'Duitsland', vlag:'🇩🇪', nickname:'Die Mannschaft',
        woorden:['Musiala','Wirtz','Kimmich','Havertz','Ter Stegen','Die Mannschaft','Berlin','Bayern München'] },
    ...
    'ENG': { naam:'Engeland', vlag:'🏴󠁧󠁢󠁥󠁮󠁧󠁿', nickname:'The Three Lions',
        woorden:['Bellingham','Kane','Saka','Foden','Declan Rice','Three Lions','Wembley','Londen','Manchester City'] },
    ...
    'SCO': { naam:'Schotland', vlag:'🏴󠁧󠁢󠁳󠁣󠁴󠁿', nickname:'The Tartan Army',
        woorden:['McTominay','Robertson','McGinn','Gilmour','Angus Gunn','Tartan Army','Hampden Park','Edinburgh','Celtic'] },
    ...
    'MAR': { naam:'Marokko', vlag:'🇲🇦', nickname:'Atlas Leeuwen',
        woorden:['Hakimi','Ziyech','En-Nesyri','Ounahi','Amrabat','Atlas Leeuwen','Rabat','Raja Casablanca'] },
    ...
    'EGY': { naam:'Egypte', vlag:'🇪🇬', nickname:'Farao\'s',
        woorden:['Salah','Marmoush','Trezeguet','Mostafa Mohamed','El Shenawy',"Farao's",'Caïro','Al-Ahly'] },
    ...
    'GHA': { naam:'Ghana', vlag:'🇬🇭', nickname:'Black Stars',
        woorden:['Mohammed Kudus','Thomas Partey','Iñaki Williams','Salisu','Semenyo','Black Stars','Accra','Asante Kotoko'] },
    'AUS': { naam:'Australië', vlag:'🇦🇺', nickname:'Socceroos',
        woorden:['Jackson Irvine','Mathew Ryan','Goodwin','Souttar','Rowles','Socceroos','Sydney','Canberra','Melbourne Victory'] },
    'JPN': { naam:'Japan', vlag:'🇯🇵', nickname:'Samurai Blue',
        woorden:['Kubo','Doan','Endo','Mitoma','Itakura','Samurai Blue','Tokyo','Vissel Kobe'] },
    ...
    'IRN': { naam:'Iran', vlag:'🇮🇷', nickname:'Team Melli',
        woorden:['Taremi','Azmoun','Jahanbakhsh','Ghoddos','Mohammadi','Team Melli','Teheran','Persepolis'] },
    ...
    'ZAF': { naam:'Zuid-Afrika', vlag:'🇿🇦', nickname:'Bafana Bafana',
        woorden:['Zwane','Tau','Teboho Mokoena','Khuliso Mudau','Williams','Bafana Bafana','Vuvuzela','Pretoria','Mamelodi Sundowns'] },
    ...
    'HAI': { naam:'Haïti', vlag:'🇭🇹', nickname:'Les Grenadiers',
        woorden:['Duckens Nazon','Frantzdy Pierrot','Metusala','Arcus','Placide','Les Grenadiers','Port-au-Prince'] },
    'CUW': { naam:'Curaçao', vlag:'🇨🇼', nickname:'Los Matadors',
        woorden:['Juninho Bacuna','Jearl Margaritha','Anita','Gorré','Room','Los Matadors','Willemstad'] },
    'SWE': { naam:'Zweden', vlag:'🇸🇪', nickname:'Blågult',
        woorden:['Isak','Kulusevski','Gyökeres','Elanga','Lindelöf','Blågult','Stockholm','Malmö FF'] },
    ...
    'CPV': { naam:'Kaapverdië', vlag:'🇨🇻', nickname:'Tubarões Azuis',
        woorden:['Ryan Mendes','Logan Costa','Jovane Cabral','Bebé','Vozinha','Tubarões Azuis','Praia'] },
    'IRQ': { naam:'Irak', vlag:'🇮🇶', nickname:'Leeuwen van Mesopotamië',
        woorden:['Aymen Hussein','Ali Jasim','Amyn','Sulaka','Hassan','Leeuwen van Mesopotamië','Bagdad','Al-Shorta'] },
    ...
    'JOR': { naam:'Jordanië', vlag:'🇯🇴', nickname:'Al-Nashama',
        woorden:['Musa Al-Taamari','Yazan Al-Naimat','Olwan','Al-Mardi','Abualaila','Al-Nashama','Amman','Al-Faisaly'] },
    'ALG': { naam:'Algerije', vlag:'🇩🇿', nickname:'Les Fennecs',
        woorden:['Mahrez','Bennacer','Aït-Nouri','Gouiri','Mandrea','Les Fennecs','Algiers','MC Alger'] },
    ...
    'UZB': { naam:'Oezbekistan', vlag:'🇺🇿', nickname:'Oq Burgutlar',
        woorden:['Shomurodov','Fayzullaev','Masharipov','Ashurmatov','Yusupov','Oq Burgutlar','Tasjkent','Pakhtakor'] }
};
...
export const WK_GROEPSWEDSTRIJDEN = [
    // Groep A
    {id:'A1',fase:'Groepsfase',poule:'A',team1:'MEX',team2:'ZAF',datum:'11 jun',extra:['Opening Groep A']},
    ...
    // Groep B
    {id:'B1',fase:'Groepsfase',poule:'B',team1:'CAN',team2:'BIH',datum:'12 jun',extra:['Opening Groep B','Gastheerland Canada']},
    ...
    // Groep C
    {id:'C1',fase:'Groepsfase',poule:'C',team1:'BRA',team2:'MAR',datum:'14 jun',extra:['Opening Groep C']},
    ...
    // Groep D
    {id:'D1',fase:'Groepsfase',poule:'D',team1:'USA',team2:'PAR',datum:'13 jun',extra:['Opening Groep D','Gastheerland VS']},
    ...
    // Groep E
    {id:'E1',fase:'Groepsfase',poule:'E',team1:'GER',team2:'CUW',datum:'14 jun',extra:['Opening Groep E']},
    ...
    // Groep F
    {id:'F1',fase:'Groepsfase',poule:'F',team1:'NED',team2:'JPN',datum:'14 jun',extra:['Opening Groep F','Oranje op het WK']},
    ...
    // Groep G
    {id:'G1',fase:'Groepsfase',poule:'G',team1:'BEL',team2:'EGY',datum:'15 jun',extra:['Opening Groep G']},
    ...
    // Groep H
    {id:'H1',fase:'Groepsfase',poule:'H',team1:'ESP',team2:'CPV',datum:'15 jun',extra:['Opening Groep H']},
    ...
    // Groep I
    {id:'I1',fase:'Groepsfase',poule:'I',team1:'FRA',team2:'SEN',datum:'16 jun',extra:['Opening Groep I']},
    ...
    // Groep J
    {id:'J1',fase:'Groepsfase',poule:'J',team1:'AUT',team2:'JOR',datum:'16 jun',extra:['Opening Groep J']},
    ...
    // Groep K
    {id:'K1',fase:'Groepsfase',poule:'K',team1:'POR',team2:'COD',datum:'17 jun',extra:['Opening Groep K']},
    ...
    // Groep L
    {id:'L1',fase:'Groepsfase',poule:'L',team1:'ENG',team2:'CRO',datum:'17 jun',extra:['Opening Groep L']},
